...
var $author$project$Options$Recv = function (a) {
	return {$: 'Recv', a: a};
};
var $author$project$Options$messageReceiver = _Platform_incomingPort('messageReceiver', $elm$json$Json$Decode$string);
...
var $author$project$Options$inputField = F3(
	function (value, label, onChangeHandler) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
...
var $author$project$Colors$yellow = A3($mdgriffith$elm_ui$Element$rgb255, 255, 215, 0);
...
var $author$project$Options$main = $elm$browser$Browser$element(
	{init: $author$project$Options$init, subscriptions: $author$project$Options$subscriptions, update: $author$project$Options$update, view: $author$project$Options$view});
_Platform_export({'Options':{'init':$author$project$Options$main(
	A2(
		$elm$json$Json$Decode$andThen,
		function (webUrl) {
			return A2(
