...
var $author$project$Popup$AuthorizePage = {$: 'AuthorizePage'};
var $author$project$Popup$SaveLinkPage = {$: 'SaveLinkPage'};
	...
	return _Utils_Tuple2(
		{
			...
			currentPage: function () {
				if (accessToken.$ === 'Just') {
					return $author$project$Popup$SaveLinkPage;
				} else {
					return $author$project$Popup$AuthorizePage;
				}
			}(),
...
var $author$project$Popup$Recv = function (a) {
	return {$: 'Recv', a: a};
};
var $author$project$Popup$messageReceiver = _Platform_incomingPort('messageReceiver', $elm$json$Json$Decode$string);
var $author$project$Popup$subscriptions = function (_v0) {
	return $author$project$Popup$messageReceiver($author$project$Popup$Recv);
};
var $author$project$Popup$SaveFailure = function (a) {
	return {$: 'SaveFailure', a: a};
};
var $author$project$Popup$SaveSuccess = {$: 'SaveSuccess'};
var $author$project$Popup$LinkAdded = function (a) {
	return {$: 'LinkAdded', a: a};
};
...
var $author$project$Popup$justOrEmptyString = function (j) {
	if (j.$ === 'Just') {
		var e = j.a;
		return e;
	} else {
...
var $author$project$Popup$postLink = function (model) {
	var base = 'http://10-25-47-4.sslip.io:4000/_';
	var url = A3(
		...
		_List_fromArray(
			[
				...
				'description',
				$author$project$Popup$justOrEmptyString(model.title)),
				A2(
				$elm$url$Url$Builder$string,
				'extended',
				$author$project$Popup$justOrEmptyString(model.note)),
				A2(
				$elm$url$Url$Builder$string,
				'url',
				$author$project$Popup$justOrEmptyString(model.url)),
				A2(
				$elm$url$Url$Builder$string,
				'tags',
				$author$project$Popup$justOrEmptyString(model.tags))
			]));
	return $elm$http$Http$request(
		{
			...
			expect: A2(
				...
				$author$project$Popup$LinkAdded,
				A2($elm$json$Json$Decode$field, 'result_code', $elm$json$Json$Decode$string)),
			headers: _List_fromArray(
				[
					...
					'Authorization',
					'Bearer ' + $author$project$Popup$justOrEmptyString(model.accessToken))
				]),
			method: 'GET',
...
var $author$project$Popup$sendMessage = _Platform_outgoingPort(
	'sendMessage',
	function ($) {
	...
	function (msg, model) {
		switch (msg.$) {
			case 'StartAuthorization':
				return _Utils_Tuple2(
					model,
					$author$project$Popup$sendMessage(
						{action: 'auth'}));
			case 'Recv':
			...
			case 'UpdateUrl':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							url: $elm$core$Maybe$Just(newUrl)
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateTitle':
				var newTitle = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							title: $elm$core$Maybe$Just(newTitle)
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateNote':
				var newNote = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							note: $elm$core$Maybe$Just(newNote)
						}),
					$elm$core$Platform$Cmd$none);
			case 'UpdateTags':
				var newTags = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							tags: $elm$core$Maybe$Just(newTags)
						}),
					$elm$core$Platform$Cmd$none);
			case 'LinkAdded':
				var x = msg.a;
				if (x.$ === 'Ok') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{currentPage: $author$project$Popup$SaveSuccess}),
						$author$project$Popup$sendMessage(
							{action: 'success'}));
				} else {
					var e = x.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								currentPage: $author$project$Popup$SaveFailure(e)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				return _Utils_Tuple2(
					model,
					$author$project$Popup$postLink(model));
		}
	});
var $author$project$Popup$StartAuthorization = {$: 'StartAuthorization'};
...
var $author$project$Popup$darkerYellow = A3($mdgriffith$elm_ui$Element$rgb255, 122, 104, 0);
...
var $author$project$Popup$yellow = A3($mdgriffith$elm_ui$Element$rgb255, 255, 215, 0);
var $author$project$Popup$createButton = F2(
	function (label, msg) {
		return A2(
			$mdgriffith$elm_ui$Element$Input$button,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color($author$project$Popup$yellow),
					$mdgriffith$elm_ui$Element$Border$color($author$project$Popup$darkerYellow),
...
var $author$project$Popup$black = A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0);
...
var $author$project$Popup$header = function () {
	var style = _List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$Border$color($author$project$Popup$black),
			$mdgriffith$elm_ui$Element$Background$color($author$project$Popup$yellow)
		]);
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(
					...
					{description: 'logo', src: '/icons/icon.svg'})),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
				...
				$mdgriffith$elm_ui$Element$text('Save to LinkHut'))
			]));
}();
...
var $author$project$Popup$layout = A2(
	...
	_List_Nil);
var $author$project$Popup$authorizeView = $author$project$Popup$layout(
	A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Popup$createButton, 'Authorize', $author$project$Popup$StartAuthorization))
			])));
...
var $author$project$Popup$failureView = function (_v0) {
	return $author$project$Popup$layout(
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$text('An error occured t__t'))
				])));
};
var $author$project$Popup$SendIt = {$: 'SendIt'};
var $author$project$Popup$UpdateNote = function (a) {
	return {$: 'UpdateNote', a: a};
};
var $author$project$Popup$UpdateTags = function (a) {
	return {$: 'UpdateTags', a: a};
};
var $author$project$Popup$UpdateTitle = function (a) {
	return {$: 'UpdateTitle', a: a};
};
var $author$project$Popup$UpdateUrl = function (a) {
...
var $author$project$Popup$saveLinkView = function (model) {
	var textInputStyle = _List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					textInputStyle,
					{
						...
						onChange: $author$project$Popup$UpdateTitle,
						placeholder: $elm$core$Maybe$Nothing,
						text: $author$project$Popup$justOrEmptyString(model.title)
					}),
					A2(
					$mdgriffith$elm_ui$Element$Input$text,
					textInputStyle,
					{
						...
						onChange: $author$project$Popup$UpdateUrl,
						placeholder: $elm$core$Maybe$Nothing,
						text: $author$project$Popup$justOrEmptyString(model.url)
					}),
					A2(
						...
						textInputStyle),
					{
						...
						onChange: $author$project$Popup$UpdateNote,
						placeholder: $elm$core$Maybe$Nothing,
						spellcheck: true,
						text: $author$project$Popup$justOrEmptyString(model.note)
					}),
					A2(
					$mdgriffith$elm_ui$Element$Input$text,
					textInputStyle,
					{
						...
						onChange: $author$project$Popup$UpdateTags,
						placeholder: $elm$core$Maybe$Nothing,
						text: $author$project$Popup$justOrEmptyString(model.tags)
					}),
					A2($author$project$Popup$createButton, 'Save', $author$project$Popup$SendIt)
				])));
};
var $author$project$Popup$successView = $author$project$Popup$layout(
	A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					{description: 'logo', src: '/icons/success-green-check-mark.svg'}))
			])));
var $author$project$Popup$view = function (model) {
	var currentPage = model.currentPage;
	switch (currentPage.$) {
		case 'SaveLinkPage':
			return $author$project$Popup$saveLinkView(model);
		case 'AuthorizePage':
			return $author$project$Popup$authorizeView;
		case 'SaveSuccess':
			return $author$project$Popup$successView;
		default:
			var e = currentPage.a;
			return $author$project$Popup$failureView(e);
	}
};
					...
					return A2(
						...
						function (accessToken) {
							return $elm$json$Json$Decode$succeed(
								{accessToken: accessToken, title: title, url: url});
						},
						A2(
